...
```{r}
needed_packages = c("ggplot2", "hexbin", "viridis", "gridExtra", "rgl", "readr", "DPpackage", "BNPdensity", "mcclust.ext", "abind", "mvtnorm")
...
which.max(hist_number_cluster$counts) # MAP estimator for K
```
